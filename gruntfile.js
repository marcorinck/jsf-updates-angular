module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		uglify: {
			core: {
				files: {
					'<%= build_dir %>/jsf-updates-angular.min.js': '<%= concat.core.dest %>'
				},
				options: {
					banner: '<%= meta.banner %>',
					report: 'gzip'
		...
		push: {
			options: {
				...
				commitFiles: ['package.json', 'bower.json', 'build/jsf-updates-angular.js', 'build/jsf-updates-angular.min.js', 'README.md'], // '-a' for all files
				createTag: true,
				tagName: 'v%VERSION%',
